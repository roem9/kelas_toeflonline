            ...
            <div class="page-wrapper" id="">
                <div class="page-body">
                    <div class="container-xl">
                        ...
                        <?php else :?>
                            <div class="row row-cards FieldContainer" data-masonry='{"percentPosition": true }'>
                                <form action="<?= base_url()?>kelas/add_jawaban_test" method="post" id="formSoal">
                                                ...
                                                <?php $pilihan .= '
                                                    <div class="mb-3">
                                                        <div class="form-check">
                                                            <div class="text-right" dir="'.$data['penulisan'].'">
                                                                <label>
                                        ...
                                        <?php elseif($data['item'] == "soal esai") :?>
                                            ...
                                            <?php $jawaban = '
                                                            <div class="form-floating mb-3">
                                                                <textarea name="jawaban[]" class="form form-control" data-id="'.$i.'" data-bs-toggle="autosize"></textarea>
